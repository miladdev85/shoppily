...
export class Form extends Component {
  ...
  render() {
    ...
    return (
      <div>
        {/* These component could also take in props. Placeholder, Did this in 5 minutes. 
        Just want to check if I have understood the question correctly. We could also just have one
